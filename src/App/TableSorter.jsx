		...
		return (
			<Centerer className="table-sorter">
				...
				<div className="actions">
					<button className="button" onClick={redoTables}>
						Refaire le tirage
					</button>
					<button className="button" onClick={generateRounds}>
						Créer les parties
					</button>
				</div>
					...
					<tbody>
						...
						{!!remainingTeam && (
							<tr className="hat">
								...
								{!!remaining && remaining.map(remain => <td>{remain.name}</td>)}
							</tr>
						)}
					</tbody>
				</table>

				<button className="button end" onClick={setTables}>
					Terminer
				</button>
			</Centerer>
		);
